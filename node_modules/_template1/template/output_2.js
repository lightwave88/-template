...
class OutputCore {
    ...
    include(filepath, data) {
        ...
        if (this.isAsync()) {
            ...
            p = p.then((context) => {
                debugger;
                return OutputCore.includeTemplate.call(this, context, data, options);
            });
            ...
            // 讀取 file 內容
            OutputCore.includeTemplate.call(this, context, data, options);
        }
    }
    //---------------------------------
    // 解析文本
    static includeTemplate(context, data, options) {
        debugger;
